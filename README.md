...
# Mobile (в новом терминале)
cd mobile_flutter && flutter run
```

### 🧪 Тестирование

1. **Открыть тестовый интерфейс**: `test-interface.html`
2. **Посмотреть инструкции**: `LOGIN_INSTRUCTIONS.md`
3. **Протестировать функции** через чек-лист в тестовом интерфейсе

### 🔑 Тестовые аккаунты

| Роль | Email | Пароль | Доступ |
|------|-------|--------|--------|
| 👤 Покупатель | buyer@example.com | password123 | Web + Mobile |
| 🏪 Продавец | seller@saqtau.kz | seller123 | Web + Mobile |
| ⚙️ Админ | admin@saqtau.kz | admin123 | Web only |
